...
class RequestHelper
{
    ...
    {
        if (isset($json['error'])) {
            Logger::addLog(Logger::ERROR_API, $json['error']['message']);
    ...
    {
        $paramFeed = RequestHelper::getRequestParam('feed', 'array', $method);
        $paramCgPreview = RequestHelper::getRequestParam('cg_preview', 'bool', $method);
